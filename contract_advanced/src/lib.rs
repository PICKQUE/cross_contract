...
const HELLO_CONTRACT: &str = "hello.near-examles.testnet";
const COUNTER_CONTRACT: &str = "counter.near-example.testnet";
const GUESTBOOK_CONTRACT: &str = "guestbook.near-example.testnet";
